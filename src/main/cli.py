...
def initialize_parser():
    ...
    # CSV parse directive
    csv_parse_directive = parse_subdirectives.add_parser('csv', help='Parse $MFT file to csv')
    
    # Bodyfile parse directive
    body_parse_directive = parse_subdirectives.add_parser('body', help='Parse $MFT MAC times to bodyfile')

    # JSON parse directive
    json_parse_directive = parse_subdirectives.add_parser('json', help='Parse $MFT file to json')

    # Database parse directive
    db_parse_directive = parse_subdirectives.add_parser('db', help='Parse $MFT file to database')
